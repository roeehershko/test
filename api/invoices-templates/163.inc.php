<?php
    $business_details['company_name'] = 'אופרי מדיקל בע"מ';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '514478833';
	$business_details['street'] = 'ניסים אלוני';
	$business_details['number'] = '19';
	$business_details['city'] = 'תל אביב';
	$business_details['zip'] = '62919';
	$business_details['phone'] = '03-6173100';
