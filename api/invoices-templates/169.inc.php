<?php
    $business_details['company_name'] = 'אלי קפה';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '000197079';
	$business_details['street'] = 'נפתלי';
	$business_details['number'] = '23';
	$business_details['city'] = 'מודיעין';
	$business_details['zip'] = '71919';
	$business_details['phone'] = '08-9750885';
