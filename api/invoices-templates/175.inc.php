<?php
    $business_details['company_name'] = 'סוככי דניאל';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '051841252';
	$business_details['street'] = 'חטיבת גולני';
	$business_details['number'] = '6';
	$business_details['city'] = 'חיפה';
	$business_details['zip'] = '33233';
	$business_details['phone'] = '04-8665410';
