<?php
    $business_details['company_name'] = 'סטודיו הדר סלקטר';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '033894288';
	$business_details['street'] = 'השקד';
	$business_details['number'] = 'א4';
	$business_details['city'] = 'רשפון';
	$business_details['zip'] = '46915';
	$business_details['phone'] = '054-4203325';
