<?php
    $business_details['company_name'] = 'Back4Rest';
	$business_details['company_number_type'] = 'ח.פ.';
	$business_details['company_number'] = '514685585';
	$business_details['street'] = 'רוטשילד';
	$business_details['number'] = '45';
	$business_details['city'] = 'ראשון לציון';
	$business_details['zip'] = '75266';
	$business_details['phone'] = '03-5031503';
    ...
    $invoice['company']['logo'] = 'https://'.constant('GTS_APP_HOST').'/invoices-templates/images/180/logo__back4rest.JPG';
