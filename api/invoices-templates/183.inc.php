<?php
    $business_details['company_name'] = 'kingcell';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '302620299';
	$business_details['street'] = 'לוינסקי';
	$business_details['number'] = '68';
	$business_details['city'] = 'תל אביב';
	$business_details['zip'] = '66855';
	$business_details['phone'] = '03-6390015';
