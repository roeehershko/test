<?php
    $business_details['company_name'] = 'לוקצקי אנה';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '307768358';
	$business_details['street'] = 'האפרסק';
	$business_details['number'] = '40';
	$business_details['city'] = 'ראש פינה';
	$business_details['zip'] = '12000';
	$business_details['phone'] = '054-4885969';
