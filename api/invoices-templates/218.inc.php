<?php
    $business_details['company_name'] = 'אל ים ואנונו בע"מ';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '511970824';
	$business_details['street'] = 'משמר הירדן';
	$business_details['number'] = '16';
	$business_details['city'] = 'ראשון לציון';
	$business_details['zip'] = '75295';
	$business_details['phone'] = '050-5759249';
