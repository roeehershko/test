<?php
    $business_details['company_name'] = 'י.א הסעות';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '316949247';
	$business_details['street'] = 'ברדיצ\'בסקי';
	$business_details['number'] = '7/2';
	$business_details['city'] = 'חולון';
	$business_details['zip'] = '58312';
	$business_details['phone'] = '050-3003936';
