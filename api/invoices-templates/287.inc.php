<?php
    $business_details['company_name'] = 'מכון לגרפולוגיה';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '023556244';
	$business_details['street'] = 'בורלא';
	$business_details['number'] = '34';
	$business_details['city'] = 'תל אביב';
	$business_details['zip'] = '69364';
	$business_details['phone'] = '050-2343341';
