<?php
    $business_details['company_name'] = 'לין תכשיטים';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '558103628';
	$business_details['street'] = 'אדיר';
	$business_details['number'] = '66';
	$business_details['city'] = 'ראש העין';
	$business_details['zip'] = '48612';
	$business_details['phone'] = '054-9794842';
