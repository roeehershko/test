<?php
    $business_details['company_name'] = 'איריס עיצובים';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '057852386';
	$business_details['street'] = 'סיטקוב יששכר';
	$business_details['number'] = '4';
	$business_details['city'] = 'רחובות';
	$business_details['zip'] = '76294';
	$business_details['phone'] = '050-7554099';
