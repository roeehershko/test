<?php
    $business_details['company_name'] = 'נטורל קולורז';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '25225814';
	$business_details['street'] = 'לוי אשכול';
	$business_details['number'] = '88';
	$business_details['city'] = 'תל אביב';
	$business_details['zip'] = '69361';
	$business_details['phone'] = '054-6663746';
