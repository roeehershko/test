<?php
    $business_details['company_name'] = 'המרכז לפסיכולוגית ספורט';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '514503655';
	$business_details['street'] = 'הפיוס';
	$business_details['number'] = '22';
	$business_details['city'] = 'הרצליה';
	$business_details['zip'] = '46814';
	$business_details['phone'] = '054-5440143';
