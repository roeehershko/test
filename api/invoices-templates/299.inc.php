<?php
    $business_details['company_name'] = 'מונית שלומי - 5 כוכבים';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '23557531';
	$business_details['street'] = 'צאלון';
	$business_details['number'] = '3';
	$business_details['city'] = 'רמת השרון';
	$business_details['zip'] = '47234';
	$business_details['phone'] = '054-3161658';
