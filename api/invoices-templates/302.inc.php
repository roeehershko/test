<?php
    $business_details['company_name'] = 'מירקין';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '314333253';
	$business_details['street'] = 'אל על';
	$business_details['number'] = '6';
	$business_details['city'] = 'רמת גן';
	$business_details['zip'] = '52412';
	$business_details['phone'] = '052-5345072';
