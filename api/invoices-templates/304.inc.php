<?php
    $business_details['company_name'] = 'פי-סי-פור-יו';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '304415219';
	$business_details['street'] = 'רקפות';
	$business_details['number'] = '18';
	$business_details['city'] = 'קרית טבעון';
	$business_details['zip'] = '36053';
	$business_details['phone'] = '050-6565230';
