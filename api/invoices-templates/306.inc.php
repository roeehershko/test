<?php
    $business_details['company_name'] = 'דודו פלד';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '24490336';
	$business_details['street'] = 'המעגל';
	$business_details['number'] = '13';
	$business_details['city'] = 'רמת גן';
	$business_details['zip'] = '52463';
	$business_details['phone'] = '054-4640020';
