<?php
    $business_details['company_name'] = 'הנחיה ייעוץ ושווק יניב';
	$business_details['company_number_type'] = 'ח.פ.';
	$business_details['company_number'] = '36311124';
	$business_details['street'] = 'אדירים';
	$business_details['number'] = '3';
	$business_details['city'] = 'תל-אביב';
	$business_details['zip'] = '69184';
	$business_details['phone'] = '052-5842055';
