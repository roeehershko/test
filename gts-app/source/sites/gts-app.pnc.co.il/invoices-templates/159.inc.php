<?php
    $business_details['company_name'] = 'מאירי יעוץ';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '032913519';
	$business_details['street'] = 'האסיף';
	$business_details['number'] = '8';
	$business_details['city'] = 'הדר-עם';
	$business_details['zip'] = '42935';
	$business_details['phone'] = '077-5080652';
    ...
    $invoice['company']['logo'] = 'https://'.constant('GTS_APP_HOST').'/invoices-templates/images/159/logo__meiri.jpg';
