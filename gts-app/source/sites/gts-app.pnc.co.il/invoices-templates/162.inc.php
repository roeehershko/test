<?php
    $business_details['company_name'] = 'רבינוביץ, שטיינר - משרד עורכי דין';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '024481046';
	$business_details['street'] = 'החשמונאים';
	$business_details['number'] = '90';
	$business_details['city'] = 'תל אביב';
	$business_details['zip'] = '61201';
	$business_details['phone'] = '03-5615555';
