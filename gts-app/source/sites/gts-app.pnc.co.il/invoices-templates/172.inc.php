<?php
    $business_details['company_name'] = 'איי.אס.אס אבטחה';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '036848612';
	$business_details['street'] = 'הדס';
	$business_details['number'] = '5';
	$business_details['city'] = 'כרמיאל';
	$business_details['zip'] = '21661';
	$business_details['phone'] = '052-2669666';
