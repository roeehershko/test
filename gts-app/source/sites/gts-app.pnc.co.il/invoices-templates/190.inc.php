<?php
    $business_details['company_name'] = 'א.ס. מחשבים';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '031685548';
	$business_details['street'] = 'טיילת נווה';
	$business_details['number'] = '35 ';
	$business_details['city'] = 'קצרין' ;
	$business_details['zip'] = '12900';
	$business_details['phone'] = '052-5634017';
