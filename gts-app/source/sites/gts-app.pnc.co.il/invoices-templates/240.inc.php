<?php
    $business_details['company_name'] = 'מוניות איליי';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '310779277';
	$business_details['street'] = 'שדרות צה"ל';
	$business_details['number'] = '30/11';
	$business_details['city'] = 'קרית גת';
	$business_details['zip'] = '82201';
	$business_details['phone'] = '052-3355400';
