<?php
    $business_details['company_name'] = 'אומנות בעץ';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '307696542';
	$business_details['street'] = 'ד.נ אפרים';
	$business_details['number'] = '0';
	$business_details['city'] = 'שילה';
	$business_details['zip'] = '44830';
	$business_details['phone'] = '054-5994275';
