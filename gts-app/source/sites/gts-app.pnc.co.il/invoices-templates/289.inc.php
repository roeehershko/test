<?php
    $business_details['company_name'] = 'קומפלט';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '039956198';
	$business_details['street'] = 'אבולעפיה';
	$business_details['number'] = '14';
	$business_details['city'] = 'תל אביב';
	$business_details['zip'] = '68054';
	$business_details['phone'] = '050-7664356';
