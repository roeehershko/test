<?php
    $business_details['company_name'] = 'פנטר';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '40979833';
	$business_details['street'] = 'משק';
	$business_details['number'] = '57';
	$business_details['city'] = 'ישרש';
	$business_details['zip'] = '76838';
	$business_details['phone'] = '050-9888892';
