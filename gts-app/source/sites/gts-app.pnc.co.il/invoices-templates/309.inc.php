<?php
    $business_details['company_name'] = 'אורי עליזי';
	$business_details['company_number_type'] = 'ע.מ.';
	$business_details['company_number'] = '7362064';
	$business_details['street'] = 'אצל';
	$business_details['number'] = '21';
	$business_details['city'] = 'הרצליה';
	$business_details['zip'] = '46750';
	$business_details['phone'] = '050-2292159';
