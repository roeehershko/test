...
<script type="text/javascript"> 
	...
	function updateProductPrice(attribute, option) {
		document.getElementById('product-price').innerHTML = '$' + ' ' + (product_price + product_attributes[attribute][option]).toFixed(2);
		<? if ($product['price_retail'] > 0 ): ?>
		document.getElementById('product-retail-price').innerHTML = '$' + ' ' + (product_retail_price + product_attributes[attribute][option]).toFixed(2);
		<? endif; ?>
	}
</script>
