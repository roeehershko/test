...
function toggle_company_form(element) {
	...
	*/
	if ($('.ui-dialog-content:visible').length > 0 && $('.ui-dialog-content:visible').dialog('isOpen')) {
		...
		ticket_form +=		'<form name="ticket_form" action="" class="ticket_form" autocomplete="off" method="POST" onsubmit="return submit_form(this, gts_company_confirmation_object)">';
		...
		// });
        pop_up_form_dialog(ticket_form,element,750,null);
	...
	*/
	if ($('.ui-dialog-content:visible').length > 0 && $('.ui-dialog-content:visible').dialog('isOpen')) {
		...
		if (element) {
			...
			merchant_parent_number = $(element).find('.merchant_parent_number').html();
		...
		var ticket_form;
		ticket_form  =	'<div class="ticket_form_container">';
		ticket_form +=		'<form name="ticket_form" action="" class="ticket_form" autocomplete="off" method="POST" onsubmit="return submit_form(this, gts_merchant_confirmation_object)">';
		...
		ticket_form += 			'<div class="field_container"><div class="label">'+strings.merchant_parent_number+'</div><div class="annotation">'+strings.merchant_parent_number__annotation+'</div><div class="field"><input type="text" name="parent_number" value="'+merchant_parent_number+'"></div></div>';
...
function toggle_vf_merchant_form(element) {
	...
	if ($('.ticket_form_container').length > 0 && typeof element !== 'undefined') {
		$('.actions button.add').html('+ '+strings.add_merchant);
		$('.ticket_form_container').slideUp('fast', function() {
			$('.ticket_form_container').remove();
			if (element) {
		...
		if (element) {
			...
			processor = $(element).find('.processor').val();
			merchant_number = $(element).find('.merchant_number').html();
			merchant_parent_number = $(element).find('.merchant_parent_number').val();
		...
		var ticket_form;
		ticket_form  =	'<div class="ticket_form_container">';
		ticket_form +=		'<form name="ticket_form" action="" class="ticket_form" autocomplete="off" method="POST" onsubmit="return submit_form(this, gts_vf_merchant_confirmation_object)">';
		...
		ticket_form += 				'<div class="field_container">';
		ticket_form += 					'<div class="label">'+strings.processor+'*</div><div class="annotation">'+strings.processor__annotation+'</div>';
		ticket_form += 					'<div class="field">';
		ticket_form += 						'<select name="processor">';
		ticket_form += 							'<option value="shva-emv"'+(processor == 'shva-emv' ? ' selected' : '')+'>SHVA EMV</option>';
		ticket_form += 							'<option value="shva"'+(processor == 'shva' ? ' selected' : '')+'>SHVA</option>';
		ticket_form += 							'<option value="creditguard"'+(processor == 'creditguard' ? ' selected' : '')+'>Credit Guard</option>';
		ticket_form += 							'<option value="signatures"'+(processor == 'signatures' ? ' selected' : '')+'>Signatures</option>';
		ticket_form += 						'</select>';
		ticket_form += 					'</div>';
		ticket_form += 				'</div>';
		...
		ticket_form += 			'<div class="field_container"><div class="label">'+strings.merchant_parent_number+'</div><div class="annotation">'+strings.merchant_parent_number__annotation+'</div><div class="field"><input class="ltr" type="text" name="parent_number" value="'+merchant_parent_number+'"></div></div>';
        ...
        ticket_form += 			'<div class="field_container">';
        ticket_form += 				'<div class="label">'+strings.invoice_template_title+'</div><div class="annotation">'+strings.invoice_template_subtitle+'</div>';
        ticket_form += 				'<div class="field">';
        ticket_form += 					'<select name="invoices[template]"'+(invoice_template ? '' : ' disabled')+'>';
        ticket_form += 						'<option value="default.he" ' + (invoice_template == 'default.he' ? 'selected' : '' ) + ' >' + strings.default_he + '</option>';
        ticket_form += 						'<option value="default.en" ' + (invoice_template == 'default.en' ? 'selected' : '' ) + ' >'+strings.default_en+'</option>';
        ticket_form += 						'<option value="default.he.without-vat-column" ' +(invoice_template == 'default.he.without-vat-column' ? 'selected' : '' )+'>'+strings.default_he_without_vat_column+'</option>';
        ticket_form += 						'<option value="default.en.without-vat-column" ' +(invoice_template == 'default.en.without-vat-column' ? 'selected' : '' )+'>'+strings.default_en_without_vat_column+'</option>';
        ticket_form += 					'</select>';
        ticket_form += 				'</div>';
        ticket_form += 			'</div>';

		ticket_form += 				'<div class="field_container"><div class="label">'+strings.charge_starting_number+'*</div><div class="annotation">'+strings.charge_starting_number__annotation+'</div><div class="field mandatory"><input class="ltr" type="text" name="invoices[charge_starting_number]" value="'+charge_starting_number+'"'+(invoice_template ? '' : ' disabled')+'></div></div>';
		ticket_form += 				'<div class="field_container"><div class="label">'+strings.refund_starting_number+'*</div><div class="annotation">'+strings.refund_starting_number__annotation+'</div><div class="field mandatory"><input class="ltr" type="text" name="invoices[refund_starting_number]" value="'+refund_starting_number+'"'+(invoice_template ? '' : ' disabled')+'></div></div>';
		...
		ticket_form += 			'<div class="field_container"><div class="label">'+strings.note+'</div><div class="annotation">'+strings.note__annotation+'</div><div class="field"><input type="text" name="params[note]" value="'+note+'"></div></div>';
        ticket_form += 			'<div class="field_container"><div class="label">'+strings.direct_access_password+'</div><div class="annotation">'+strings.direct_access_password__annotation+'</div><div class="field"><input class="ltr" type="text" name="direct_access_password" value=""><a class="direct_access_password" onclick="generate_direct_access_password($(this).parent().find(\'input\'))">'+strings.generate_direct_access_password+'</a></div></div>';
		ticket_form += 			'<div class="submit_container">';
		...
		ticket_form +=				'<button type="button" onclick="send_password(\'email\', $(\'input[name=username]:visible\'), $(\'input[name=password]:visible\'), \'\', $(\'input.company_email:visible\'))">'+strings.send_password_by_email+'</button>';
		ticket_form +=				'<button type="button" onclick="send_password(\'sms\', $(\'input[name=username]:visible\'), $(\'input[name=password]:visible\'), $(\'input[name=mobile]:visible\'))">'+strings.send_password_by_sms+'</button>';

		ticket_form += 				'<button type="button" onclick="window.location=\''+href_url+'gts/verifone/reports?type=transactions&merchant_id='+id+'\'">'+strings.transactions_report+'</button>';
		ticket_form += 				'<button type="button" onclick="window.location=\''+href_url+'gts/verifone/reports?type=errors&merchant_id='+id+'\'">'+strings.errors_report+'</button>';
        if (id && (current_user.type == 'tech-admin' || current_user.type == 'content-admin' || current_user.type == 'gts_admin')) {
		    ticket_form +=              '<div class="submit_delete_btns_container">';
            ticket_form += 				     '<button type="submit" class="submit_fix">'+strings.approve+'</button>';
		...
		// 	$.scrollTo('.tickets', {duration:400});
		// });
        pop_up_form_dialog(ticket_form,element,815,650,'merchant');
    }
}

function get_error_or_merchants_reports (id) {
    if ($('#report select').val() == 'errors_report') {
        window.location='/gts/verifone/reports?type=errors&merchant_id='+id;
    } else {
        window.location='/gts/verifone/reports?type=transactions&merchant_id='+id;
    }
}
...
function merchant_enable_invoices(value) {
	if (value == 1) {
		...
		*/
		$('select[name="invoices[template]"]').removeAttr('disabled');
		$('input[name="invoices[charge_starting_number]"').removeAttr('disabled');
		$('input[name="invoices[refund_starting_number]"').removeAttr('disabled');
	} else {
		$('.invoice_parameters_container').hide();
		$('.invoice_parameters_container input').val('');
		$('select[name="invoices[template]"]').attr('disabled', 'disabled');
		$('input[name="invoices[charge_starting_number]"').attr('disabled', 'disabled');
		$('input[name="invoices[refund_starting_number]"').attr('disabled', 'disabled');
	}
}
...
function toggle_vf_user_form(element) {
	...
	if ($('.ticket_form_container').length > 0 && typeof element !== 'undefined') {
		...
		var ticket_form;
		ticket_form  =	'<div class="ticket_form_container">';
		ticket_form +=		'<form name="ticket_form" action="" class="ticket_form" autocomplete="off" method="POST" onsubmit="return submit_form(this, gts_vf_user_confirmation_object)">';
		...
		ticket_form += 			'<div class="submit_container">';
		ticket_form +=				'<button type="button" onclick="send_password(\'email\', $(\'input.gts_user_username:visible\'), $(\'input.gts_user_password:visible\'), \'\', $(\'input.gts_user_email:visible\'))">'+strings.send_password_by_email+'</button>';
		ticket_form +=				'<button type="button" onclick="send_password(\'sms\', $(\'input.gts_user_username:visible\'), $(\'input.gts_user_password:visible\'), $(\'input.gts_user_mobile:visible\'))">'+strings.send_password_by_sms+'</button>';
		if (id && (current_user.type == 'tech-admin' || current_user.type == 'content-admin' || current_user.type == 'gts_admin')) {
			ticket_form +=               '<div class="submit_delete_btns_container">';
		...
		// 	$.scrollTo('.tickets', {duration:400});
		// });
        pop_up_form_dialog(ticket_form,element,750,null,'user');
	}
}
...
function toggle_user_form(element) {
	...
	*/
	if ($('.ui-dialog-content:visible').length > 0 && $('.ui-dialog-content:visible').dialog('isOpen')) {
		...
		var ticket_form;
		ticket_form  =	'<div class="ticket_form_container">';
		ticket_form +=		'<form name="ticket_form" action="" class="ticket_form" autocomplete="off" method="POST" onsubmit="return submit_form(this, gts_user_confirmation_object)">';
		...
		// 	$.scrollTo('.tickets', {duration:400});
		// });
        pop_up_form_dialog(ticket_form,element,750,null,null);
	}
}
...
function toggle_change_password_form() {
	...
	*/
	if ($('.ui-dialog-content:visible').length > 0 && $('.ui-dialog-content:visible').dialog('isOpen')) {
		...
		var ticket_form;
		ticket_form  =	'<div class="ticket_form_container">';
		ticket_form +=		'<form name="ticket_form" action="" class="ticket_form" autocomplete="off" method="POST" onsubmit="return submit_form(this, gts_change_password_confirmation_object)">';
	...
	*/
	if ($('.ui-dialog-content:visible').length > 0 && $('.ui-dialog-content:visible').dialog('isOpen')) {
		...
		if (element) {
			...
			ticket_form  =	'<div class="ticket_form_container">';
			ticket_form +=		'<form name="ticket_form" action="" class="ticket_form" autocomplete="off" method="POST" onsubmit="return submit_form(this, gts_email_voucher_confirmation_object)">';
	...
	*/
	if ($('.ui-dialog-content:visible').length > 0 && $('.ui-dialog-content:visible').dialog('isOpen')) {
		...
		if (element) {
            ...
            ticket_d_id = $(element).find('.ticket_d.id').html();
            trans_type = $(element).find('.ticket_d.trans_type').html();
            cc_type = $(element).find('.ticket_d.cc_type').html();

            cc_exp = $(element).find('.ticket_d.cc_exp').html();
            authorization_number = $(element).find('.ticket_d.authorization_number').html();
            voucher_number = $(element).find('.ticket_d.voucher_number').html();

			transaction_merchant_username = $(element).find('.transaction_merchant_username').val();
			transaction_merchant_company_name = $(element).find('.transaction_merchant_company_name').val();

            payment_info = $(element).find('.ticket_d.amount').attr("title");

			ticket_form  =	'<div class="ticket_form_container">';
			ticket_form +=		'<form name="ticket_form" action="" class="ticket_form" autocomplete="off" method="POST" onsubmit="return submit_form(this, gts_send_voucher_confirmation_object)">';
			ticket_form += 			'<input type="hidden" name="action" value="gts_send_voucher">';
			ticket_form += 			'<input type="hidden" name="id" value="'+id+'">';
			ticket_form += 			'<input type="hidden" name="merchant_id" value="'+(current_user && current_user.merchant_id ? current_user.merchant_id : '')+'">';
			ticket_form += 			'<input type="hidden" name="admin" value="'+(current_user && current_user.type == 'gts_admin' ? 1 : '')+'">';
			ticket_form += 			'<div class="field_container"><div class="label">'+strings.amount+'</div><div class="annotation">'+amount+'</div></div>';
			ticket_form += 			'<div class="field_container"><div class="label">'+strings.timestamp+'</div><div class="annotation">'+timestamp+'</div></div>';
            ticket_form += 			'<div class="field_container"><div class="label">'+strings.cc_last_4+'</div><div class="annotation">'+cc_last_4+'</div></div>';
            ticket_form += 			'<div class="field_container"><div class="label">'+strings.id+'</div><div class="annotation">'+ticket_d_id+'</div></div>';
            ticket_form += 			'<div class="field_container"><div class="label">'+strings.credit_terms+'</div><div class="annotation">'+trans_type+'</div></div>';
            if (trans_type.indexOf(strings.payments) != -1){
                ticket_form += 			'<div class="field_container"><div class="label">'+strings.payments+'</div><div class="annotation payment_info">'+payment_info+'</div></div>';
            }
            ticket_form += 			'<div class="field_container"><div class="label">'+strings.cc_type+'</div><div class="annotation">'+cc_type+'</div></div>';
            ticket_form += 			'<div class="field_container"><div class="label">'+strings.cc_exp+'</div><div class="annotation">'+cc_exp+'</div></div>';
            ticket_form += 			'<div class="field_container"><div class="label">'+strings.authorization_number+'</div><div class="annotation">'+authorization_number+'</div></div>';
			ticket_form += 			'<div class="field_container"><div class="label">'+strings.voucher_number+'</div><div class="annotation">'+voucher_number+'</div></div>';

			if (note) {
				ticket_form += 			'<div class="field_container"><div class="label">'+strings.note+'</div><div class="annotation">'+note+'</div></div>';
			}

			if (transaction_merchant_username) {
				ticket_form += 			'<div class="field_container"><div class="label">'+strings.username+'</div><div class="annotation">'+transaction_merchant_username+'</div></div>';
			}
			if (transaction_merchant_company_name) {
				ticket_form += 			'<div class="field_container"><div class="label">'+strings.company_name+'</div><div class="annotation">'+transaction_merchant_company_name+'</div></div>';
			}
		...
		// });
        //CSS to add
        //.ui-widget-header {background: rgba(255, 222, 173, 0);color: #222222/*{fcHeader}*/;font-weight: bold;border: none;}
        // .ticket_form .submit_container {    margin: 45px 0 0 1px;    font-size: 20px;}
        //.ticket_form .submit_container button {float:left;width: 60px;height: 35px;}
        pop_up_form_dialog(ticket_form,element,750,null,null);
	}
}
...
function toggle_transaction_form(element) {
	...
	*/
	if ($('.ui-dialog-content:visible').length > 0 && $('.ui-dialog-content:visible').dialog('isOpen')) {
        ...
        //Remove because we start use pop up
		//$('.actions button.add').html('- '+strings.cancel_add_transaction);
		var ticket_form;

		ticket_form  =	'<div class="ticket_form_container">';
		ticket_form +=		'<form name="ticket_form" action="" class="ticket_form" autocomplete="off" method="POST" onsubmit="return submit_form(this, gts_transaction_confirmation_object)">';
		...
		// 	$.scrollTo('.tickets', {duration:400});
		// });
        pop_up_form_dialog(ticket_form,element,750,650,null);
	}
}
...
function toggle_recurring_order_form(element) {
	...
	*/
	if ($('.ui-dialog-content:visible').length > 0 && $('.ui-dialog-content:visible').dialog('isOpen')) {
		...
		ticket_form  =	'<div class="ticket_form_container">';
		ticket_form +=		'<form name="ticket_form" action="" class="ticket_form" autocomplete="off" method="POST" onsubmit="return submit_form(this, gts_recurring_order_confirmation_object)">';
	...
	if (confirm(strings.are_you_sure)) {
		$.post(href_url, {action:'gts_delete_type', type:type, id:id}, function(data) {
			if (data.status == 'okay') {
                ...
                if ($('.ui-dialog-titlebar-close.ui-corner-all')){
		...
		setTimeout(function() {
			if (signal_required) {
				if ($(field).data('field_validated')) {
					...
					$(field).closest('.field_container').find('.annotation').removeClass('highlight');
				} else {
					$(validation_container).parent().prepend('<div class="validation"><span class="fail">&#10008;</span></div>');
					$(field).closest('.field_container').find('.annotation').addClass('highlight');
					/*var custom_validity = $(field).closest('.field_container').find('.annotation').html();
					if ($(field) && $(field)[0] && custom_validity) {
						$(field)[0].setCustomValidity(custom_validity);
					}*/
				}
...
function generate_direct_access_password(element) {

    var password = "";

    while (password.length < 58) {
        password += Math.random().toString(16).substring(2);
    }
	   element.val(password.substring(0,58));
}

function pop_up_form_dialog(form,element,width,height,merchant_or_user){
    ...
    $('.ui-dialog.ui-widget.ui-widget-content.ui-corner-all.ui-draggable.ui-resizable').on('dialogclose', function(event) {
        ...
        if (merchant_or_user == 'user') {
            $('body').find('.actions button.add').html('+ '+strings.add_user);
        } else {
            if (merchant_or_user == 'merchant'){
                $('body').find('.actions button.add').html('+ '+strings.add_merchant);
            }
        }
    });
...
$(document).ready(function() {
	...
	gts_merchant_confirmation_object.callback = function(data) {
		...
		cells = '\
			...
			<div class="ticket_d merchant_parent_number">'+data.merchant.merchant_parent_number+'</div>\
	...
	gts_vf_merchant_confirmation_object.callback = function(data) {
		...
		alert(strings.confirmation__data_saved);
		cells = '\
			<input type="hidden" class="processor" value="'+(data.merchant.processor ? data.merchant.processor : '')+'">\
			...
			\
			<input type="hidden" class="merchant_parent_number" value="'+(data.merchant.parent_number ? data.merchant.parent_number : '')+'">\
			\
        ...
        //Remove to prevent a new pop up
